...
<body  style="background-image: url('assets/img/loginpic.jpg')" >
		...
		<div id="loginbox" style="margin-top: 15%;"
			...
			<div class="panel panel-info">
				...
				<div style="padding-top: 30px" class="panel-body">
					...
					<form id="loginform" class="form-horizontal" role="form"  action="login" method="post" name ="f">
						...
						<div style="margin-top: 10px" class="form-group">
							...
							<div class="col-sm-12 controls">
								<a id="btn-login" href="javascript:document.f.submit();" class="btn btn-success">Login </a>
